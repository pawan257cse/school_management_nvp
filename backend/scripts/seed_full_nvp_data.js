...
async function seedAll() {
  ...
  // 8. Students Seeding (DISABLED - Real student admissions will be added by School Admin)
  console.log('Skipping sample student creation (Admissions Register is clean for live student entries)...');
