...
async function syncOfficialTimetable() {
  ...
  const teacherDefs = [
    ...
    { name: 'Megha', email: 'megha@nvpschool.edu.in', phone: '+91 98290 11008', empId: 'EMP-T108', classTeacherOf: ['5'], classesTaught: ['1', '2', '5', '6'], subjectsTaught: ['English', 'Hindi Grammar', 'Sanskrit'] },
  ...
  // 4. Exact Table from NVP_School_Time_Table...pdf with clean single subjects
