    ...
    <header className="no-print sticky top-0 z-30 h-16 sm:h-20 bg-slate-900 border-b border-slate-800 px-3 sm:px-8 flex items-center justify-between shadow-lg">
      ...
      <div className="flex items-center gap-2 sm:gap-3 min-w-0">
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-1.5 sm:gap-2">
            <h1 className="font-heading font-extrabold text-white text-sm sm:text-base md:text-lg tracking-tight truncate">
      ...
      <div className="flex items-center gap-2 sm:gap-4 shrink-0">
        ...
        <div className="flex items-center gap-2 sm:gap-3 pl-2 sm:pl-3 border-l border-slate-800">
          <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white font-bold flex items-center justify-center text-xs sm:text-sm shadow-lg shadow-indigo-500/30">
            {user?.name?.[0]}
          </div>
          <div className="hidden md:block text-left">
            <p className="text-xs font-bold text-white truncate max-w-[200px]">{user?.name}</p>
