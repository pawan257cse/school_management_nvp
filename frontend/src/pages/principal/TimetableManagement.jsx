...
export default function TimetableManagement() {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-2.5 sm:p-3 rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="p-3.5 sm:p-4 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs font-bold bg-indigo-50 text-indigo-700 hover:bg-indigo-100 px-3 py-1.5 rounded-lg border border-indigo-200 transition shrink-0"
          >
        ...
        {/* Mobile Swipe Notice */}
        <div className="sm:hidden px-3 py-1.5 bg-indigo-50 border-b border-indigo-100 text-[10px] text-indigo-700 font-bold flex items-center gap-1.5">
          <span>👈 Swipe horizontally to view & edit all period columns 👉</span>
        </div>
